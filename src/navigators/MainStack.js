...
import AdicionarShowScreen from "../pages/AdicionarShow/AdicionarShowScreen";
...
export default () => {
  return (
    ...
    >
      ...
      <MainStack.Screen
        name='AdicionarRepertorio'
        component={AdicionarRepertorioScreen}
      />
      <MainStack.Screen name='AdicionarShow' component={AdicionarShowScreen} />
